...
| [data-buffer](https://crates.io/crates/data_buffer) | D-ML(alloc) 1 / ABP 1 | ptr-as | [![GitHub issue/pull request detail](https://img.shields.io/github/issues/detail/state/elrnv/buffer/2)](https://github.com/elrnv/buffer/issues/2) |
...
| [preserves](https://crates.io/crates/preserves) | D-ML 1 / ABP 1 | ptr-as | [![GitLab all issues](https://img.shields.io/gitlab/issues/all/preserves%2Fpreserves?logo=gitlab&label=Unsoundness%20in%20%60receive_output_value%60)](https://gitlab.com/preserves/preserves/-/issues/42) |
